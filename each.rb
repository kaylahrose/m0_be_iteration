...
weather_options.each do |weather_option|
  p "The weather is #{weather_option} today."
end
...
# recording doesn't have to be the first time you are solving the problem. Use
# technical vocabulary and explain each part to demonstrate your understanding!
